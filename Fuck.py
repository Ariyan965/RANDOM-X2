...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        print(f'\r%s[%s!%s] %s__%s  '%(N,M,N,M,N))
    else:
        print(f'\r[•_•] %s \x1b[1;95m  T_      :{WHITE}'%(GREEN))
    ...
    game = [i.text for i in x.find_all("h3")]
    if len(game)==0:
        print(f'\r%s[%s!%s] %s_%s           \n'%(N,M,N,M,N))
    else:
        print(f'\r[•_•] %s \x1b[1;95m  T_     :{WHITE}'%(M))
        for i in range(len(game)):
...
[1;92m•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••[1;92m
[1;92m[•_•] [1;92mDEVOLPER   :          ARIYAN[1;92m          
[1;92m[•_•] [1;92mFACEBOOK   :          Ariyan \________// ;* :/ 3:)[1;92m          
[1;92m[•_•] [1;92mGITHUB     :          Ariyan 965[1;92m           
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f'\033[0;97m[{xr}•_•{x}]\033[0;92m EXAMPLE : \033[1;97m10000, \x1b[1;93m20000, \033[1;92m50000 ] \n\033[0;95m•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○•••○○○••• \n\033[0;97m[{xr}•_•{x}] \033[0;92m LIMIT:\033[1;92m '))
